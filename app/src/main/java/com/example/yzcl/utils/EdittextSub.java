 ...
 */
//只能输入两位小数
public class EdittextSub extends AppCompatEditText implements TextWatcher {
    public EdittextSub(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EdittextSub(Context context) {
        super(context);
        init();
    }
