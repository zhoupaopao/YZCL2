...
public class SearchHistoryDeviceAdapter extends RecyclerView.Adapter<SearchHistoryDeviceAdapter.SHViewHolder> {
    private DeviceSearchAcrivity context;
    private ArrayList<String>list;
    private SharedPreferences sp;
    public SearchHistoryDeviceAdapter(DeviceSearchAcrivity context, ArrayList<String> list){
