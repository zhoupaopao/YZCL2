...
import com.example.yzcl.mvp.ui.JieQingSearchActivity;
...
public class SettleListSearchAdapter extends BaseAdapter {
    ArrayList<SettleListBean.SettleBean>list;
    JieQingSearchActivity context;
    LayoutInflater mInflater;
    SettleListBean.SettleBean settleBean;
    public SettleListSearchAdapter(JieQingSearchActivity context, ArrayList<SettleListBean.SettleBean> list){
