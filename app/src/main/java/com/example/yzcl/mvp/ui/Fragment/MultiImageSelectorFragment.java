...
import com.example.yzcl.adapter.FolderAdapter;
import com.example.yzcl.adapter.ImageGridAdapter;
import com.example.yzcl.mvp.model.bean.Folder;
import com.example.yzcl.mvp.model.bean.Image;
import com.example.yzcl.utils.FileUtils;
import com.example.yzcl.utils.ScreenUtils;
        ...
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    Log.i("contentUri", getActivity()+"");
                    Log.i("contentUri", FileUtils.getApplicationId(getActivity()) + ".provider");
                    Log.i("contentUri", mTmpFile+"");
