...
public class CustomerManagerActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        client.get(Api.GetCustomer, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                try {
                    ...
                    if(CustomerMBean.getObject().getTree()==null){
                        Toast.makeText(CustomerManagerActivity.this,"没有子账户",Toast.LENGTH_SHORT).show();

                    }
                     SimpleTreeeAdapter adapter=new SimpleTreeeAdapter<NewFileBean>(tree_list, CustomerManagerActivity.this, mData, 10);
                    ...
                    adapter.setOnTreeNodeClickListener(new TreeListViewwAdapter.OnTreeNodeClickListener() {
                        ...
                        public void onClick(Node3 node, int position) {
                            ...
                            Toast.makeText(CustomerManagerActivity.this,node.getUseid(),Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            public void onStart() {
                super.onStart();
                progress= DialogUIUtils.showLoading(CustomerManagerActivity.this, "加载中...",false,true,true,false);
                progress.show();
